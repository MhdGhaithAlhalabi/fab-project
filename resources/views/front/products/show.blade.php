                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> {{ trans('Messages.category') }} :<a
                                    ...
                                    @foreach ($product->attributes as $attr)
                                        <div class="col-lg-4 col-md-4 col-12">
                                            <div class="form-group">
                                                <label class="title-label"> {{ $attr->name }}</label>
                                                @php
                                                    if (LaravelLocalization::getCurrentLocale() == 'ar') {
                                                        $values = collect($attr->pivot->values_ar);
                                                    } elseif (LaravelLocalization::getCurrentLocale() == 'en') {
                                                        $values = collect($attr->pivot->values_en);
                                                    } else {
                                                        $values = collect($attr->pivot->values_tr);
                                                    }
                                                    $ff = [];
                                                    ...
                                                    $gg = implode(',', $ff);
                                                    $collection = collect(json_decode($gg, true));
                                                @endphp
                                                <select class="form-control" id="color" name="options[{{ $attr->name }}]">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="info-body custom-responsive-margin">
                                ...
                                <h4>{{ trans('Messages.features') }}</h4>
                                <ul class="features">
                                    @php
                                        $values = collect($product->features);
                                        $ff = [];
                                        foreach ($values as $val) {
                                            $ff[] = $val;
                                        }
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="info-body">
                                <h4>{{ trans('Messages.specifications') }}</h4>
                                <ul class="normal-list">
                                    @php
                                    $values = collect($product->specifications);
                                    $ff = [];
                                    foreach ($values as $val) {
                                        $ff[] = $val;
                                    }
