                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="breadcrumbs-content">
                            <h1 class="page-title">{{ trans('Messages.checkout') }}</h1>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-12">
                        <ul class="breadcrumb-nav">
                            <li><a href="{{ route('home') }}"><i class="lni lni-home"></i> {{ trans('Messages.home') }}</a></li>
                            <li><a href="{{ route('home') }}">{{ trans('Messages.shop') }}</a></li>
                            <li>{{ trans('Messages.checkout') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <form action="{{ route('checkout') }}" method="post" id="payment-form">
                        ...
                        <div class="checkout-steps-form-style-1">
                            <ul id="accordionExample">
                                <li>
                                    <h6 class="title" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">{{ trans('Messages.your personal details') }}</h6>
                                    <section class="checkout-steps-form-content collapse show" id="collapseThree" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    <label>{{ trans('Messages.user name') }}</label>
                                                    <div class="row">
                                                        <div class="col-md-6 form-input form">
                                                            <x-form.input name="addr[billing][first_name]" placeholder="{{ trans('Messages.first name') }}" />
                                                        </div>
                                                        <div class="col-md-6 form-input form">
                                                            <x-form.input name="addr[billing][last_name]" placeholder="{{ trans('Messages.last name') }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[billing][email]" placeholder="{{ trans('Messages.email address') }}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[billing][phone_number]" placeholder="{{ trans('Messages.phone number') }}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    <label>{{ trans('Messages.mailing address') }}</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[billing][street_address]" placeholder="{{ trans('Messages.mailing address') }}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[billing][city]" placeholder="{{ trans('Messages.city') }}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    <label>{{ trans('Messages.post code') }}</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[billing][postal_code]" placeholder="{{ trans('Messages.post code') }}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="select-items">
                                                        <x-form.input name="addr[billing][state]" placeholder="{{ trans('Messages.state') }}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="checkout-payment-form">
                                                    <div class="single-form form-default button">
                                                        <button type="submit" id="submit" class="btn">{{ trans('Messages.order now') }}</button>
                                                    </div>
                                                </div>
                                                <div class="checkout-payment-form">
                                                    <div class="single-form form-default button">
                                                        <a href="{{ route('home') }}" class="btn btn-alt">{{ trans('Messages.continue shopping') }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="col-lg-4">
                    {{-- <div class="checkout-sidebar">
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            <h5 class="title">{{ trans('Messages.pricing table') }}</h5>
                            @foreach ($cart->get() as $item)
                            <div class="sub-total-price">
                                <div class="total-price">
                                    <p class="value">{{ trans('Messages.product name') }} :</p>
                                    <p class="price">{{ $item->product->name }}</p>
                                </div>
                                <div class="total-price">
                                    <p class="value">{{ trans('Messages.quantity') }} :</p>
                                    <p class="price">{{ $item->quantity}}</p>
                                </div>
                                <div class="total-price">
                                    <p class="value">{{ trans('Messages.subtotal') }} :</p>
                                    <p class="price">{{ Currency::format($item->quantity * $item->product->price) }}</p>
                                </div>
                            </div>
                            <hr>
                            @endforeach
                            <div class="sub-total-price">
                                <div class="total-price">
                                    <p class="value">{{ trans('Messages.total') }} :</p>
