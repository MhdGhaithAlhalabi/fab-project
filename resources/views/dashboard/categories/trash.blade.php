...
@section('title', 'سلة محذوفات الاصناف')

@section('breadcrumb')
    @parent
    <li class="breadcrumb-item">الاصناف</li>
...
<div class="mb-5">
    <a href="{{ route('dashboard.categories.index') }}" class="btn btn-sm btn-outline-primary">رجوع</a>
</div>
...
<table class="table">
    ...
    <tbody>
        ...
        @empty
        <tr>
            <td colspan="7">لا يوجد اصناف في السلة</td>
        </tr>
        @endforelse
    </tbody>
</table>
