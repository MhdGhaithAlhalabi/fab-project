<div class="cart-items">
    ...
    <div class="shopping-item">
        <div class="dropdown-cart-header">
            <span>{{ $items->count() }} {{ trans('Messages.items') }}</span>
            <a href="{{ route('cart.index') }}">{{ trans('Messages.view cart') }}</a>
        </div>
        ...
        <div class="bottom">
            ...
            <div class="button">
                <a href="{{ route('checkout') }}" class="btn animate">{{ trans('Messages.checkout') }}</a>
            </div>
        </div>
    </div>
    <!--/ End Shopping Item -->
