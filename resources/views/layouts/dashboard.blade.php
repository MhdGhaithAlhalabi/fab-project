...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('dist/css/adminlte_l.css') }}">
    @stack('styles')
</head>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        ...
                        <form action="{{ route('logout') }}" method="post">
                            @csrf
                            <button type="submit" class="btn btn-sm btn-outline-primary">تسجيل الخروج</button>
                        </form>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2022-2023 <a href="https://mhdghaithalhalabi.github.io">Mhd Ghaith Alhalabe</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
